...
namespace ptoVenta
{
    public partial class cierreCajaTest : Form
    {
        SqlCommand com;
        SqlDataReader dr;
        ...
        private void totalventas()
        {
            ...
            comsql1 = "SELECT F.NOMBRE CONCEPTO,F.NUMERO,F.IMPUESTO,F.MONTO,F.TIPO,F.ABONO,R.TIPO,R.RECIBO,F.FECHA,R.CAJA,R.EFECTIVO,R.DEBITO,R.CREDITO,R.NTRANSFERENCIA,R.OTROS,R.FACTURA,R.VUELTO,F.REGISTRO ";
        ...
        private void cierreCajaTest_VisibleChanged(object sender, EventArgs e)
        {
            txtEfectivo.Focus();
        }
